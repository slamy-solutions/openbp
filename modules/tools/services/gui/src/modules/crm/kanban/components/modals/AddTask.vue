...
import { IProject, useProjectStore } from 'src/stores/project-store';
...
import Project from 'src/components/modals/Project.vue';
...
export default defineComponent({
  ...
  watch: {
    async client(newValue: IClient) {
      if (newValue) {
        ...
        this.task.contact = this.contactStore.contactById(
  ...
  methods: {
    ...
    createContact() {
      this.editContact.clientId = this.client.id;
