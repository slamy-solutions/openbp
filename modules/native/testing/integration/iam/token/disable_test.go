...
func (suite *DisableTestSuite) TearDownSuite() {
	suite.nativeStub.Close()
}
func TestDisableTestSuite(t *testing.T) {
	suite.Run(t, new(DisableTestSuite))
}

func (s *DisableTestSuite) TestDisableInGlobalNamespace() {
...
func (s *DisableTestSuite) TestDisableInNamespace() {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*5)
	defer cancel()
...
func (s *DisableTestSuite) TestDisableNonExistingTokenFromGlobalNamespace() {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*5)
	defer cancel()
...
func (s *DisableTestSuite) TestDisableNonExistingTokenFromNamespace() {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*5)
	defer cancel()
...
func (s *DisableTestSuite) TestFailsIfNamespaceDoesntExist() {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*5)
	defer cancel()
