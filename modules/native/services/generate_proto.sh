...
mkdir -p ./lambda-manager/src/grpc/native_file
protoc --go_out=./lambda-manager/src/grpc/native_file --go_opt=paths=source_relative --go-grpc_out=./lambda-manager/src/grpc/native_file --go-grpc_opt=paths=source_relative -I ../proto file.proto
