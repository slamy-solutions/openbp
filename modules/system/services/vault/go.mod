module github.com/slamy-solutions/openbp/modules/system/services/vault

go 1.21.0

replace github.com/slamy-solutions/openbp/modules/system/libs/golang => ../../libs/golang
