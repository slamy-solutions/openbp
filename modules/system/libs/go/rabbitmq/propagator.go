...
func InjectTelemetryAMQPHeaders(ctx context.Context) map[string]interface{} {
...
func ExtractTelemetryAMQPHeaders(ctx context.Context, headers map[string]interface{}) context.Context {
